...
class Initializer extends Zend_Controller_Plugin_Abstract
{
    ...
    public function initControllers ()
    {
        ...
        $front->addControllerDirectory($this->_root.'/application/modules/private/php/controllers', 'private');
        $front->addControllerDirectory($this->_root.'/application/modules/mobile/php/controllers', 'mobile');
